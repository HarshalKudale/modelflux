/**
 * MessageInput - Native Implementation
 * Full functionality with RAG sources button
 */
...
export function MessageInput({
    ...
    const isRagEnabled = (ragSettings?.isEnabled || hasSources) && !isStale && hasDefaultProvider;
